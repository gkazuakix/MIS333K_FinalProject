...
//add the database
String strConnection = "Server=tcp:fa22team16.database.windows.net,1433;Initial Catalog=fa22team16;Persist Security Info=False;User ID=team16;Password=Password123!;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
builder.Services.AddDbContext<AppDbContext>(options => options.UseSqlServer(strConnection));

//This is NEW code for HW4, HW5, and the Project
